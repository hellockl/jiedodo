...
include_once __DIR__.'/Exceptions/APIConnectionException.php';
include_once __DIR__.'/Exceptions/APIRequestException.php';
include_once __DIR__.'/Exceptions/ServiceNotAvaliable.php';
final class Http {
