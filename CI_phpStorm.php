 ...
 * @property CI_Weixin $weixin                    my weixin library
 * @property CI_Alipay $alipay                    my alipay library
 * @property CI_Fwhweixin $fwhweixin              my fwhweixin library
 * @property CI_Pinyin $pinyin                    my pinyin library
 * @property CI_Mweixin $mweixin                   weimob weixin library
 * @property CI_Extend $extend                    extend library
 * @property checkad $checkad                     checkad library
 * @property CI_Page $page                     	  page library
 */
